...
public class Hello {
	...
	*/
	public	static	void	main(String[]	args)	{	
		...
		images[0] = loadImg("Coca_1.jpg");
		images[1] = loadImg("Coca_2.jpg");
	...
	private static void displaySiftComparison() {
		Mat[] images = new Mat[2];
		images[0] = loadImgLena();
		images[1] = loadImgLena();
	...
	private static Mat loadImgLena() {
	...
	private static Mat loadImg(String imageName) {
